...
static const char qt_meta_stringdata_uart[] = {
    "uart\0\0send()\0str\0receive_d(QString)\0"
    "thread_start()\0"
};
...
void uart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receive_d((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->thread_start(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData uart::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject uart::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_uart,
      qt_meta_data_uart, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &uart::getStaticMetaObject() { return staticMetaObject; }
