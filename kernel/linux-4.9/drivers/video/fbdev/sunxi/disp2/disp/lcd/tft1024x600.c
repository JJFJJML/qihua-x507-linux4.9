...
// the first parameter 0:lcd id
// the second parameter 0:the lcd gpio index[not the actul gpio pin]
// the last parameter val:the lcd gpio value

#define LCD_RESET(val)   (sunxi_lcd_gpio_set_value(0, 0, val))
...
struct __lcd_panel tft1024x600_panel = {
	/* panel driver name, must mach the name of lcd_drv_name in sys_config.fex */
	.name = "tft1024x600_lcd",
	.func = {
