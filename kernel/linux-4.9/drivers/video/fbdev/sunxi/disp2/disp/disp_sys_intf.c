...
bool is_pcf8574a_port(int gpio_port)
{
	return gpio_port >= 504;  //pcf8574a base port num is 504 on t507 plateform
}
			  ...
			  u32 group_count_max)
{
	...
	if(is_pcf8574a_port(pin_cfg.gpio)){
		gpio_set_value(pin_cfg.gpio, 1);
	}
...
{
	if(is_pcf8574a_port(p_handler)){
		gpio_set_value(p_handler, 0);
	}
