...
/*-------------------------------------------------------------------------*/
static int pcf857x_gpio_of_xlate(struct gpio_chip *gc, const struct of_phandle_args *gpiospec, u32 *flags)
{
			 ...
			 const struct i2c_device_id *id)
{
    ...
    gpio->chip.of_xlate = pcf857x_gpio_of_xlate;
