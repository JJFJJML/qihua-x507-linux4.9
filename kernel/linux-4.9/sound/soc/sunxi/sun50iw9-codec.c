...
static bool codec_spk_open = 0;
//extern bool is_bk1088_spk_open(void);
...
bool is_codec_spk_open(void){
	return codec_spk_open;
}
EXPORT_SYMBOL(is_codec_spk_open);
