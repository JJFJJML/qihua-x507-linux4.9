...
void rawnand_dump_clock(void)
{

#define PLL_PER0 ((volatile unsigned int *)0x03001020)
#define NAND_CCLK ((volatile unsigned int *)0x03001810)
#define NAND_DCLK ((volatile unsigned int *)0x03001814)
#define MBUS_CLK ((volatile unsigned int *)0x03001540)
#define MBUS_MASK ((volatile unsigned int *)0x03001804)
	RAWNAND_INFO("%08x: %x\n", PLL_PER0, readl(PLL_PER0));
	RAWNAND_INFO("%08x: %x\n", NAND_CCLK, readl(NAND_CCLK));
	RAWNAND_INFO("%08x: %x\n", NAND_DCLK, readl(NAND_DCLK));
	RAWNAND_INFO("%08x: %x\n", MBUS_CLK, readl(MBUS_CLK));
	RAWNAND_INFO("%08x: %x\n", MBUS_MASK, readl(MBUS_MASK));
}

void rawnand_dump_gpio_nand(void)
{
#define GPIO_C_0    ((volatile unsigned int *)0x0300B048)
#define GPIO_C_1    ((volatile unsigned int *)0x0300B04C)
#define GPIO_C_2    ((volatile unsigned int *)0x0300B050)
#define GPIO_C_MUL    ((volatile unsigned int *)0x0300B05c)
#define GPIO_C_PUL_0    ((volatile unsigned int *)0x0300B064)
#define GPIO_C_PUL_1    ((volatile unsigned int *)0x0300B068)
#define GPIO_WIST    ((volatile unsigned int *)0x0300B340)

	RAWNAND_INFO("%08x: %x\n", GPIO_C_0, readl(GPIO_C_0));
	RAWNAND_INFO("%08x: %x\n", GPIO_C_1, readl(GPIO_C_1));
	RAWNAND_INFO("%08x: %x\n", GPIO_C_2, readl(GPIO_C_2));
	RAWNAND_INFO("%08x: %x\n", GPIO_C_MUL, readl(GPIO_C_MUL));
	RAWNAND_INFO("%08x: %x\n", GPIO_C_PUL_0, readl(GPIO_C_PUL_0));
	RAWNAND_INFO("%08x: %x\n", GPIO_C_PUL_1, readl(GPIO_C_PUL_1));
	RAWNAND_INFO("%08x: %x\n", GPIO_WIST, readl(GPIO_WIST));
}
/**
